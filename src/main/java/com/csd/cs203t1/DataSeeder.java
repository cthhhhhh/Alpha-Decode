...
public class DataSeeder implements CommandLineRunner {
	...
	private void handleWeeklyLeaderboardReset() {
		...
		String lastResetStr = metadata.getValue();
		boolean resetNeeded = false;
		
		if (lastResetStr == null || lastResetStr.isEmpty()) {
			// First time setup - mark it as done for today
			resetNeeded = true;
		} else {
			LocalDate lastResetDate = LocalDate.parse(lastResetStr);
			if (lastResetDate.isBefore(lastMonday)) {
				resetNeeded = true;
			}
		}
		
		if (resetNeeded) {
			log.info("Starting Weekly Leaderboard Reset (Safety Check)...");
			userRepository.resetAllWeeklyCoins();
			metadata.setValue(today.toString());
	...
	private void seedLessons() {
		...
		seedSlangExpressionLessons();
		seedBehavioralSlangLessons();
		seedInternetPhenomenaLessons();
	}

	private void seedCoreLingoLessons() {
		lessonService.addLesson(lesson("Rizz Basics", "green", "Charisma, attraction, and smooth talk.", "✨"),
				List.of(
						intro("New Word: Rizz",
						...
						select("What does \"Rizz\" mean?", null,
								List.of("Being rich", "Charisma", "Running fast",
										"Sleeping"),
								1, "Rizz is short for cha-rizz-ma!"),
						translate("Translate this sentence", "He has charisma",
								List.of("He", "has", "rizz", "Ohio", "skibidi"),
								"He has rizz",
								"In Gen Alpha slang, charisma is replaced with rizz."),
						select("Complete the sentence",
								"She has so much ____, she can talk to anyone.",
						...
						select("What is \"unspoken rizz\"?", null,
								List.of("Being loud", "Charming without speaking",
										"Being shy", "Having a bad jawline"),
								1,
								"Unspoken rizz is raw charisma that doesn't even need words."),
						translate("Translate this sentence", "She got major charisma",
								List.of("She", "got", "major", "rizz", "Ohio", "gyatt"),
								"She got major rizz",
								"Major charisma translates to major rizz.")));

		lessonService.addLesson(
				lesson("Fanum Tax", "orange", "The art of taking a bite from someone else's food.",
						"🍕"),
				List.of(
		...
		lessonService.addLesson(lesson("Ohio Lore", "purple", "Where everything weird happens.", "🌀"), List.of(
				...
				select("Ohio describes something that is...", null,
						List.of("Cool and trendy", "Weird or bizarre", "Expensive",
								"Delicious"),
						1,
						"Ohio memes portray the state as a place where bizarre, surreal things happen."),
				translate("Translate this sentence", "Strange auctions only in Ohio",
						List.of("Only", "in", "Ohio", "strange", "rizz", "sigma"),
						"Only in Ohio",
						"The classic meme phrase is \"Only in Ohio\"."),
				select("A dog from Ohio probably has...", null,
						List.of("A normal tail", "Laser eyes or three heads", "Good behavior",
								"A trophy"),
						1,
				...
				translate("Translate this sentence", "This food is weird",
						List.of("This", "food", "is", "Ohio", "rizz", "skibidi"),
						"This food is Ohio",
						"Replace \"weird\" with \"Ohio\" for full slang usage.")));

		lessonService.addLesson(
				lesson("Skibidi 101", "blue",
						"The chaotic viral word from the Skibidi Toilet universe.", "🚽"),
				List.of(
						...
						select("\"Skibidi\" is generally used to describe something...", null,
								List.of("Awesome", "Delicious", "Weird or bad", "Fast"),
								2,
	...
	private void seedLifestyleLessons() {
		lessonService.addLesson(
				...
				List.of(
						...
						select("Mewing is done to improve your...", null,
								List.of("Abs", "Jawline", "Hair", "Eyesight"),
								1,
								"Mewing is a tongue posture technique promoted to define the jawline."),
						translate("Translate this sentence", "I am resting my tongue",
								List.of("I", "am", "mewing", "rizz", "sigma",
										"skibidi"),
								"I am mewing",
								"The act of proper tongue posture is called mewing."),
						select("If someone points to their jaw and stays quiet, they are...",
								null,
						...
						select("Where should your tongue be while mewing?", null,
								List.of("Against your teeth", "Roof of your mouth",
										"Tucked under", "Sticking out"),
								1,
								"Full tongue contact with the roof of the mouth is the key."),
						translate("Translate this sentence", "Silence is the grind",
								List.of("Silence", "is", "mewing", "sigma", "rizz",
										"Ohio"),
								"Silence is mewing",
								"Mewing requires silence to maintain focus.")));

		lessonService.addLesson(lesson("Sigma Mindset", "gray", "The lone wolf who needs no one.", "🐺"),
				List.of(
		...
		lessonService.addLesson(lesson("Delulu Land", "pink", "Delusional positivity is the solution.", "💭"),
				List.of(
						...
						select("\"Delulu\" is short for...", null,
								List.of("Dedicated", "Delusional", "Deliberate",
										"Delighted"),
								1,
						...
						translate("Translate this sentence", "You are delusional",
								List.of("You", "are", "delulu", "rizz", "sigma",
										"skibidi"),
								"You are delulu",
								"Delusional becomes delulu in slang."),
						select("What is the \"solulu\"?", null,
								List.of("The reality", "The problem", "The delulu",
										"The truth"),
								2,
						...
						translate("Translate this sentence", "Delusional is the solution",
								List.of("Delulu", "is", "the", "solulu", "rizz",
										"sigma"),
								"Delulu is the solulu",
								"Translating the popular ironic catchphrase.")));
	}

	private void seedSlangExpressionLessons() {
		lessonService.addLesson(lesson("No Cap", "red", "For real, not lying.", "🧢"), List.of(
				...
				select("Which sentence uses \"no cap\" correctly?", null,
						List.of("No cap, I slept for 12 hours", "No cap me outside",
								"No cap you later",
								"No cap is a hat"),
						0,
						"\"No cap, I slept for 12 hours\" correctly uses it to emphasise truth."),
				select("\"Cap\" in slang means...", null,
						List.of("A hat", "The limit", "A lie", "Winning"), 2,
						"\"Cap\" = lie or exaggeration. So \"no cap\" = no lie."),
				translate("Translate this sentence", "I am not lying, that was amazing",
						List.of("No", "cap", "that", "was", "amazing", "rizz"),
				...
				translate("Translate this sentence", "She is serious, that actually happened",
						List.of("She", "is", "no", "cap", "that", "happened"),
						"She is no cap that happened",
		...
		lessonService.addLesson(lesson("Bussin", "yellow", "Extremely good, usually food.", "🍔"), List.of(
				...
				select("\"This pizza is bussin\" means...", null,
						List.of("The pizza is burning", "The pizza is disgusting",
				...
				select("Which sentence is correct?", null,
						List.of("That burger is bussin bussin", "That bussin is burger",
								"The bussin eats good",
								"Bussin the meal"),
						0,
						"\"Bussin bussin\" doubles the emphasis — it means really, really good."),
				translate("Translate this sentence", "This food is extremely good",
						List.of("This", "food", "is", "bussin", "cap", "delulu"),
						"This food is bussin",
						"Extremely good food = bussin."),
				translate("Translate this sentence", "That meal was fire and amazing",
						List.of("That", "meal", "was", "bussin", "fr", "ohio"),
						"That meal was bussin fr",
						"Bussin + fr (for real) doubles the sincerity of the compliment.")));
	}

	private void seedBehavioralSlangLessons() {
		lessonService.addLesson(lesson("Lowkey", "slate", "Secretly or subtly.", "🤫"), List.of(
				...
				select("\"Lowkey\" means...", null,
						List.of("Very loudly", "Secretly or subtly", "Obviously", "Not at all"),
						1,
				...
				select("\"I lowkey love this song\" means...", null,
						List.of("I hate this song", "I openly love this song",
								"I secretly enjoy this song",
								"I don't know this song"),
						2,
						"Lowkey here means the speaker quietly enjoys it but may not want to admit it."),
				translate("Translate this sentence", "I secretly think he is cute",
						List.of("I", "lowkey", "think", "he", "is", "cute"),
						"I lowkey think he is cute",
						"Secret feelings = lowkey."),
				translate("Translate this sentence", "She openly hates mornings",
						List.of("She", "highkey", "hates", "mornings", "lowkey", "cap"),
						"She highkey hates mornings",
						"Openly/very much = highkey.")));

		lessonService.addLesson(
				lesson("NPC Behaviour", "zinc", "Acting robotic with no original thought.", "🤖"),
				List.of(
						intro("New Word: NPC",
						...
						select("An NPC in slang is someone who...", null,
								List.of("Is very creative", "Follows the crowd blindly",
										"Is extremely athletic",
										"Leads others"),
								1,
								"NPC = someone acting like a background character with no individual thought."),
						select("\"NPC behaviour\" at a protest means...", null,
								List.of("Leading the charge",
										"Chanting slogans without knowing why",
										"Organising the event",
										"Leaving early"),
								1,
								"NPC behaviour = following without thinking, like a scripted game character."),
						select("The phrase 'NPC mindset' is...", null,
								List.of("A compliment", "Neutral", "An insult",
										"A goal"),
								2,
		...
		lessonService.addLesson(
				...
				List.of(
						...
						select("\"Main character energy\" is about...", null,
								List.of("Being shy and quiet",
										"Treating yourself as the hero of your story",
										"Following others",
										"Avoiding attention"),
								1,
								"Main character energy = acting like life is your movie and you're the star."),
						select("Which action shows main character energy?", null,
								List.of("Sitting in the corner silently",
										"Walking in slow-motion to a dramatic song",
										"Copying someone else's style",
										"Avoiding eye contact"),
								1,
								"Slow-motion walks and dramatic music are classic main character moments."),
						select("The opposite of main character is...", null,
								List.of("Side character", "NPC", "Both A and B",
										"Sigma"),
								2,
						...
						translate("Translate this sentence",
								...
								List.of("She", "has", "main", "character", "energy",
										"ohio"),
								"She has main character energy",
								"Owning the room = main character energy."),
						translate("Translate this sentence",
								"Stop acting like you are in a movie",
								List.of("Stop", "acting", "like", "the", "main",
										"character"),
								"Stop acting like the main character",
								"Being overly dramatic = acting like the main character.")));

		lessonService.addLesson(lesson("Based", "stone", "Holding a strong opinion unapologetically.", "🗿"),
				List.of(
						...
						select("\"Based\" is used to describe someone who...", null,
								List.of("Agrees with everyone",
										"Is unapologetically themselves",
										"Is always wrong",
										"Is very quiet"),
								1,
								"Based = authentic, confident, doesn't care about others' opinions."),
						select("Calling someone \"based\" is...", null,
								List.of("An insult", "Neutral", "A compliment",
										"A question"),
								2,
								"Based is a compliment — it means you admire their confident authenticity."),
						select("\"That's a based take\" means...", null,
								List.of("That opinion is boring",
										"That opinion is confidently authentic",
										"That opinion is wrong",
										"That opinion is popular"),
								1,
								"A based take = a confident, genuine opinion you stand behind regardless of backlash."),
						translate("Translate this sentence", "He is unapologetically himself",
								List.of("He", "is", "based", "no", "cap", "sigma"),
								"He is based",
								"Unapologetically authentic = based."),
						translate("Translate this sentence",
								"That is a bold and genuine opinion",
								List.of("That", "is", "a", "based", "take", "rizz"),
								"That is a based take",
								"Bold, genuine opinion = based take.")));
	}

	private void seedInternetPhenomenaLessons() {
		lessonService.addLesson(lesson("Rent Free", "cyan", "Living in your head without permission.", "🧠"),
				List.of(
						...
						select("\"Living rent free in my head\" means...", null,
								List.of("I paid for something",
										"I can't stop thinking about it",
										"I forgot about it completely",
										"I own a house"),
								1,
								"Rent free = occupying mental real estate without permission."),
						select("Which is an example of living rent free?", null,
								List.of("Forgetting an exam",
										"Obsessively replaying an embarrassing moment",
										"Sleeping peacefully",
										"Ignoring drama"),
								1,
								"Replaying an embarrassing moment = it's living rent free in your head."),
						select("If a song is \"rent free\", you...", null,
								List.of("Hate it completely",
										"Can't stop thinking about or humming it",
										"Never heard of it",
										"Composed it"),
								1,
								"The song keeps playing in your mind involuntarily — classic rent free."),
						translate("Translate this sentence", "That meme will not leave my head",
								List.of("That", "meme", "lives", "rent", "free", "in",
										"my", "head"),
								"That meme lives rent free in my head",
								"Can't get it out of your head = living rent free."),
						translate("Translate this sentence", "She is always on my mind",
								List.of("She", "lives", "rent", "free", "in", "my",
										"head"),
								"She lives rent free in my head",
								"Constantly thinking about someone = living rent free.")));

		lessonService.addLesson(lesson("It's Giving", "emerald", "It has the energy or vibe of...", "✨"),
				List.of(
						...
						select("\"It's giving\" is closest in meaning to...", null,
								List.of("It costs a lot", "It has the vibe of",
										"It is giving away",
										"It belongs to someone"),
								1, "It's giving = it exudes / it has the energy of."),
						select("\"That speech is giving main character\" means...", null,
								List.of("The speech was boring",
										"The speech had main character energy",
										"The speech was a gift",
						...
						translate("Translate this sentence", "This party has sigma energy",
								List.of("This", "party", "is", "giving", "sigma",
										"bussin"),
								"This party is giving sigma",
								"Giving + descriptor = it has that energy.")));

		lessonService.addLesson(lesson("Touch Grass", "green", "Go outside, disconnect from internet.", "🌿"),
				List.of(
						...
						select("\"Touch grass\" means...", null,
								List.of("Plant a garden", "Go outside and disconnect",
										"Win an argument", "Touch someone"),
								1,
								"Touch grass = go outside, skill issue detected, you're too online."),
						select("You would tell someone to touch grass if they...", null,
								List.of("Win a sports game",
										"Have been arguing online for hours",
										"Cook a great meal",
										"Study all night"),
								1,
								"Someone who is too deep in internet drama needs to touch grass."),
						select("Telling someone to touch grass is...", null,
								List.of("Encouraging them to garden",
										"An insult meaning they're too online",
										"A compliment for creativity",
										"A meme about Ohio"),
								1,
								"It's a mildly dismissive suggestion — you need a reality check, go outside."),
						translate("Translate this sentence", "Please go outside and log off",
								List.of("Please", "touch", "grass", "and", "log",
										"off"),
								"Please touch grass and log off",
								"Go outside = touch grass."),
						translate("Translate this sentence", "You are too online right now",
								List.of("You", "need", "to", "touch", "grass", "sigma"),
								"You need to touch grass",
								"Too online = needs to touch grass.")));

		lessonService.addLesson(lesson("Caught in 4K", "indigo", "Caught with undeniable evidence.", "📷"),
				List.of(
						...
						select("\"Caught in 4K\" means...", null,
								List.of("Caught watching TV",
										"Caught with undeniable clear evidence",
										"Caught making a 4K video",
										"Caught in Ohio"),
								1,
								"4K = ultra-high resolution — caught so clearly there's no denying it."),
						select("You are caught in 4K when...", null,
								List.of("Nobody sees you",
										"You're caught on camera doing something undeniably",
										"You win a bet", "You delete evidence"),
								1,
								"Caught in 4K = evidence so clear it's irrefutable."),
						select("The 4K in this phrase refers to...", null,
								List.of("4000 dollars", "High resolution video quality",
										"4000 people watching", "4K hours"),
								1,
						...
						translate("Translate this sentence", "He was caught red-handed lying",
								List.of("He", "was", "caught", "in", "4K", "lying"),
								"He was caught in 4K lying",
								"Caught red-handed with clear evidence = caught in 4K."),
						translate("Translate this sentence", "The video proves she was there",
								List.of("She", "was", "caught", "in", "4K", "no",
										"cap"),
								"She was caught in 4K no cap",
								"Undeniable video proof = caught in 4K.")));

		lessonService.addLesson(lesson("Vibe Check", "purple", "Assessing someone's energy or mood.", "🎵"),
				List.of(
						...
						select("A vibe check is...", null,
								List.of("A music test",
										"An assessment of someone's mood or energy",
										"A vibration sensor",
										"A math quiz"),
								1,
								"Vibe check = checking the vibe/energy someone is giving off."),
						select("If you fail the vibe check, you...", null,
								List.of("Have great energy", "Have won a prize",
										"Have bad or off energy",
										"Are very skilled"),
								2,
								"Failing the vibe check means your vibe/energy is not good."),
						select("\"The whole party failed the vibe check\" means...", null,
								List.of("The party was amazing", "Nobody danced",
										"The energy of the whole party was off",
										"Everyone passed the test"),
								2,
								"The energy of the whole party was wrong or uncomfortable."),
						translate("Translate this sentence",
								"Check if this place has good energy",
								List.of("Vibe", "check", "this", "place", "bussin",
										"ohio"),
								"Vibe check this place",
								"Assessing energy = vibe check."),
						translate("Translate this sentence", "His mood is completely off today",
								List.of("He", "failed", "the", "vibe", "check",
										"today"),
								"He failed the vibe check today",
	...
	private void seedOnboardingQuiz() {
		...
		SelectQuestion q1 = SelectQuestion.builder()
				...
				.options(List.of("A government fee", "Stealing food", "Paying for fans",
						"A dance move"))
				.correctAnswer(1)
				.explanation("Fanum Tax means stealing a bite from someone else's food.").quiz(oq)
				.build();
		...
		SelectQuestion q3 = SelectQuestion.builder()
				...
				.correctAnswer(0).explanation("Skibidi Toilet is the viral YouTube series.").quiz(oq)
				.build();
		...
		SelectQuestion q4 = SelectQuestion.builder()
				...
				.correctAnswer(0)
				.explanation("Mewing is a tongue posture exercise to define the jawline.").quiz(oq)
				.build();
		...
		SelectQuestion q5 = SelectQuestion.builder()
				...
				.correctAnswer(1)
				.explanation("A Sigma is an independent lone wolf outside the social hierarchy.")
				.quiz(oq).build();
	...
	private void seedAchievements() {
		List<Achievement> defaults = List.of(
				achievement("First Lesson", "Complete your very first lesson", "🌱",
						TriggerType.LESSON_COMPLETE, 1),
				achievement("Halfway There", "Complete 10 out of 20 lessons", "🚀",
						TriggerType.LESSON_COMPLETE, 10),
				achievement("Alpha Graduate", "Complete all 20 lessons", "🎓",
						TriggerType.LESSON_COMPLETE, 20),
				achievement("Streak Starter", "Maintain a 3-day streak", "🔥", TriggerType.STREAK_DAYS,
						3),
		...
		achievementRepository.findAll().forEach(a -> {
			if (!defaultNames.contains(a.getName())) {
