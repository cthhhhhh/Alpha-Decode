...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedLessons() {
        ...
        lessonService.addLesson(lesson("No Cap", "red", "For real, not lying.", "🧢"), List.of(
            intro("New Word: No Cap", "\"No cap\" means \"for real\" or \"I'm not lying\". It is used to emphasise that something is true.", "Example: \"That was the best burger I've ever had, no cap.\""),
            select("What does \"no cap\" mean?", null, List.of("Just kidding", "For real, not lying", "I give up", "Maybe"), 1, "No cap = I'm not capping (lying). It means you're being completely serious."),
            select("Which sentence uses \"no cap\" correctly?", null, List.of("No cap, I slept for 12 hours", "No cap me outside", "No cap you later", "No cap is a hat"), 0, "\"No cap, I slept for 12 hours\" correctly uses it to emphasise truth."),
            select("\"Cap\" in slang means...", null, List.of("A hat", "The limit", "A lie", "Winning"), 2, "\"Cap\" = lie or exaggeration. So \"no cap\" = no lie."),
            translate("Translate this sentence", "I am not lying, that was amazing", List.of("No", "cap", "that", "was", "amazing", "rizz"), "No cap that was amazing", "Replace 'I am not lying' with 'No cap'."),
            translate("Translate this sentence", "She is serious, that actually happened", List.of("She", "is", "no", "cap", "that", "happened"), "She is no cap that happened", "No cap is inserted to reinforce the truth of the statement.")
        ));

        lessonService.addLesson(lesson("Slay", "rose", "Do something excellently.", "💅"), List.of(
            intro("New Word: Slay", "\"Slay\" means to do something exceptionally well or to look amazing. It is a compliment for someone who is crushing it.", "Example: \"She slayed that presentation.\""),
            select("\"Slay\" is used to describe...", null, List.of("Destroying something", "Doing something excellently", "Sleeping in", "Losing a game"), 1, "Slay = to perform or look absolutely outstanding."),
            select("Which sentence uses \"slay\" correctly?", null, List.of("She slayed the math test", "He slayed the river", "They slayed the couch", "I slayed lunch"), 0, "\"She slayed the math test\" = she did an amazing job on it."),
            select("When someone says \"slay queen\", they mean...", null, List.of("Attack the queen", "You are doing great", "Be careful", "Stay quiet"), 1, "\"Slay queen\" is a term of encouragement meaning you're excelling."),
            translate("Translate this sentence", "She did an excellent job", List.of("She", "slayed", "it", "ohio", "rizz", "sigma"), "She slayed it", "\"Did an excellent job\" becomes \"slayed it\" in slang."),
            translate("Translate this sentence", "You look absolutely amazing today", List.of("You", "are", "slaying", "today", "cap", "mewing"), "You are slaying today", "Looking amazing = slaying.")
        ));

        lessonService.addLesson(lesson("Bussin", "yellow", "Extremely good, usually food.", "🍔"), List.of(
            intro("New Word: Bussin", "\"Bussin\" means extremely good, and is most commonly used to describe food. It originated from African-American Vernacular English (AAVE).", "Example: \"This ramen is bussin fr.\""),
            select("\"Bussin\" is most often used for...", null, List.of("Weather", "Food", "Music videos", "Sports"), 1, "Bussin is predominantly used to describe food that tastes amazing."),
            select("\"This pizza is bussin\" means...", null, List.of("The pizza is burning", "The pizza is disgusting", "The pizza is extremely good", "The pizza is too expensive"), 2, "Bussin = extremely good, especially for food."),
            select("Which sentence is correct?", null, List.of("That burger is bussin bussin", "That bussin is burger", "The bussin eats good", "Bussin the meal"), 0, "\"Bussin bussin\" doubles the emphasis — it means really, really good."),
            translate("Translate this sentence", "This food is extremely good", List.of("This", "food", "is", "bussin", "cap", "delulu"), "This food is bussin", "Extremely good food = bussin."),
            translate("Translate this sentence", "That meal was fire and amazing", List.of("That", "meal", "was", "bussin", "fr", "ohio"), "That meal was bussin fr", "Bussin + fr (for real) doubles the sincerity of the compliment.")
        ));

        lessonService.addLesson(lesson("Lowkey", "slate", "Secretly or subtly.", "🤫"), List.of(
            intro("New Word: Lowkey", "\"Lowkey\" means secretly, subtly, or to a moderate degree. Its opposite, \"highkey\", means openly or very much so.", "Example: \"I lowkey want dessert but I won't say it out loud.\""),
            select("\"Lowkey\" means...", null, List.of("Very loudly", "Secretly or subtly", "Obviously", "Not at all"), 1, "Lowkey = secretly or to a subtle degree."),
            select("\"Highkey\" is the ____ of lowkey.", null, List.of("Synonym", "Opposite", "Slang version", "Translation"), 1, "Highkey means openly or very much — the opposite of lowkey."),
            select("\"I lowkey love this song\" means...", null, List.of("I hate this song", "I openly love this song", "I secretly enjoy this song", "I don't know this song"), 2, "Lowkey here means the speaker quietly enjoys it but may not want to admit it."),
            translate("Translate this sentence", "I secretly think he is cute", List.of("I", "lowkey", "think", "he", "is", "cute"), "I lowkey think he is cute", "Secret feelings = lowkey."),
            translate("Translate this sentence", "She openly hates mornings", List.of("She", "highkey", "hates", "mornings", "lowkey", "cap"), "She highkey hates mornings", "Openly/very much = highkey.")
        ));

        lessonService.addLesson(lesson("NPC Behaviour", "zinc", "Acting robotic with no original thought.", "🤖"), List.of(
            intro("New Word: NPC", "NPC stands for Non-Playable Character (from video games). In slang, calling someone an NPC means they act robotically, follow the crowd, and have no original thoughts.", "Example: \"He just agreed with everyone — total NPC behaviour.\""),
            select("An NPC in slang is someone who...", null, List.of("Is very creative", "Follows the crowd blindly", "Is extremely athletic", "Leads others"), 1, "NPC = someone acting like a background character with no individual thought."),
            select("\"NPC behaviour\" at a protest means...", null, List.of("Leading the charge", "Chanting slogans without knowing why", "Organising the event", "Leaving early"), 1, "NPC behaviour = following without thinking, like a scripted game character."),
            select("The phrase 'NPC mindset' is...", null, List.of("A compliment", "Neutral", "An insult", "A goal"), 2, "Being called an NPC is an insult — it means you lack original thought or personality."),
            translate("Translate this sentence", "He just follows without thinking", List.of("He", "is", "such", "an", "NPC", "sigma"), "He is such an NPC", "Following without original thought = being an NPC."),
            translate("Translate this sentence", "Stop acting like a background character", List.of("Stop", "acting", "like", "an", "NPC", "rizz"), "Stop acting like an NPC", "Background character with no agency = NPC.")
        ));

        lessonService.addLesson(lesson("Main Character", "violet", "Treating yourself as the protagonist.", "🎬"), List.of(
            intro("New Word: Main Character", "\"Main character energy\" means treating yourself as the protagonist of your own life story — confident, dramatic, and at the centre of attention.", "Example: \"She walked in like she was the main character.\""),
            select("\"Main character energy\" is about...", null, List.of("Being shy and quiet", "Treating yourself as the hero of your story", "Following others", "Avoiding attention"), 1, "Main character energy = acting like life is your movie and you're the star."),
            select("Which action shows main character energy?", null, List.of("Sitting in the corner silently", "Walking in slow-motion to a dramatic song", "Copying someone else's style", "Avoiding eye contact"), 1, "Slow-motion walks and dramatic music are classic main character moments."),
            select("The opposite of main character is...", null, List.of("Side character", "NPC", "Both A and B", "Sigma"), 2, "Both side characters and NPCs represent people who aren't the focus — main character is the opposite."),
            translate("Translate this sentence", "She walks in like she owns the place", List.of("She", "has", "main", "character", "energy", "ohio"), "She has main character energy", "Owning the room = main character energy."),
            translate("Translate this sentence", "Stop acting like you are in a movie", List.of("Stop", "acting", "like", "the", "main", "character"), "Stop acting like the main character", "Being overly dramatic = acting like the main character.")
        ));

        lessonService.addLesson(lesson("Based", "stone", "Holding a strong opinion unapologetically.", "🗿"), List.of(
            intro("New Word: Based", "\"Based\" means holding a strong, genuine opinion and being unapologetically yourself — regardless of what others think. It is a compliment for authenticity.", "Example: \"He wore that outfit with full confidence. Based.\""),
            select("\"Based\" is used to describe someone who...", null, List.of("Agrees with everyone", "Is unapologetically themselves", "Is always wrong", "Is very quiet"), 1, "Based = authentic, confident, doesn't care about others' opinions."),
            select("Calling someone \"based\" is...", null, List.of("An insult", "Neutral", "A compliment", "A question"), 2, "Based is a compliment — it means you admire their confident authenticity."),
            select("\"That's a based take\" means...", null, List.of("That opinion is boring", "That opinion is confidently authentic", "That opinion is wrong", "That opinion is popular"), 1, "A based take = a confident, genuine opinion you stand behind regardless of backlash."),
            translate("Translate this sentence", "He is unapologetically himself", List.of("He", "is", "based", "no", "cap", "sigma"), "He is based", "Unapologetically authentic = based."),
            translate("Translate this sentence", "That is a bold and genuine opinion", List.of("That", "is", "a", "based", "take", "rizz"), "That is a based take", "Bold, genuine opinion = based take.")
        ));

        lessonService.addLesson(lesson("Rent Free", "cyan", "Living in your head without permission.", "🧠"), List.of(
            intro("New Word: Rent Free", "Something \"living rent free\" in your head means you can't stop thinking about it, even if you want to. It occupies mental space without you inviting it.", "Example: \"That song is living rent free in my head.\""),
            select("\"Living rent free in my head\" means...", null, List.of("I paid for something", "I can't stop thinking about it", "I forgot about it completely", "I own a house"), 1, "Rent free = occupying mental real estate without permission."),
            select("Which is an example of living rent free?", null, List.of("Forgetting an exam", "Obsessively replaying an embarrassing moment", "Sleeping peacefully", "Ignoring drama"), 1, "Replaying an embarrassing moment = it's living rent free in your head."),
            select("If a song is \"rent free\", you...", null, List.of("Hate it completely", "Can't stop thinking about or humming it", "Never heard of it", "Composed it"), 1, "The song keeps playing in your mind involuntarily — classic rent free."),
            translate("Translate this sentence", "That meme will not leave my head", List.of("That", "meme", "lives", "rent", "free", "in", "my", "head"), "That meme lives rent free in my head", "Can't get it out of your head = living rent free."),
            translate("Translate this sentence", "She is always on my mind", List.of("She", "lives", "rent", "free", "in", "my", "head"), "She lives rent free in my head", "Constantly thinking about someone = living rent free.")
        ));

        lessonService.addLesson(lesson("It's Giving", "emerald", "It has the energy or vibe of...", "✨"), List.of(
            intro("New Word: It's Giving", "\"It's giving\" is used to describe the vibe, energy, or feeling that something exudes. It's like saying 'it reminds me of' or 'it has the energy of'.", "Example: \"That outfit is giving royalty.\""),
            select("\"It's giving\" is closest in meaning to...", null, List.of("It costs a lot", "It has the vibe of", "It is giving away", "It belongs to someone"), 1, "It's giving = it exudes / it has the energy of."),
            select("\"That speech is giving main character\" means...", null, List.of("The speech was boring", "The speech had main character energy", "The speech was a gift", "The speech was too short"), 1, "The speech gave off main character vibes."),
            select("\"It's giving chaos\" describes something that is...", null, List.of("Very orderly", "Extremely chaotic or wild", "Expensive", "Quiet"), 1, "Giving chaos = exuding chaotic energy."),
            translate("Translate this sentence", "That outfit has royal energy", List.of("That", "outfit", "is", "giving", "royalty", "ohio"), "That outfit is giving royalty", "Having the vibe of something = it's giving [that thing]."),
            translate("Translate this sentence", "This party has sigma energy", List.of("This", "party", "is", "giving", "sigma", "bussin"), "This party is giving sigma", "Giving + descriptor = it has that energy.")
        ));

        lessonService.addLesson(lesson("Touch Grass", "green", "Go outside, disconnect from internet.", "🌿"), List.of(
            intro("New Word: Touch Grass", "\"Touch grass\" means to go outside and disconnect from the internet. It's told to people who are too online, arguing too hard online, or being unhinged on social media.", "Example: \"You've been arguing about this for 6 hours. Touch grass.\""),
            select("\"Touch grass\" means...", null, List.of("Plant a garden", "Go outside and disconnect", "Win an argument", "Touch someone"), 1, "Touch grass = go outside, skill issue detected, you're too online."),
            select("You would tell someone to touch grass if they...", null, List.of("Win a sports game", "Have been arguing online for hours", "Cook a great meal", "Study all night"), 1, "Someone who is too deep in internet drama needs to touch grass."),
            select("Telling someone to touch grass is...", null, List.of("Encouraging them to garden", "An insult meaning they're too online", "A compliment for creativity", "A meme about Ohio"), 1, "It's a mildly dismissive suggestion — you need a reality check, go outside."),
            translate("Translate this sentence", "Please go outside and log off", List.of("Please", "touch", "grass", "and", "log", "off"), "Please touch grass and log off", "Go outside = touch grass."),
            translate("Translate this sentence", "You are too online right now", List.of("You", "need", "to", "touch", "grass", "sigma"), "You need to touch grass", "Too online = needs to touch grass.")
        ));

        lessonService.addLesson(lesson("Caught in 4K", "indigo", "Caught with undeniable evidence.", "📷"), List.of(
            intro("New Word: Caught in 4K", "\"Caught in 4K\" means being caught red-handed with absolutely undeniable, crystal-clear evidence. It references 4K video resolution — so clear there's no denying it.", "Example: \"He lied about being sick but was caught in 4K at the mall.\""),
            select("\"Caught in 4K\" means...", null, List.of("Caught watching TV", "Caught with undeniable clear evidence", "Caught making a 4K video", "Caught in Ohio"), 1, "4K = ultra-high resolution — caught so clearly there's no denying it."),
            select("You are caught in 4K when...", null, List.of("Nobody sees you", "You're caught on camera doing something undeniably", "You win a bet", "You delete evidence"), 1, "Caught in 4K = evidence so clear it's irrefutable."),
            select("The 4K in this phrase refers to...", null, List.of("4000 dollars", "High resolution video quality", "4000 people watching", "4K hours"), 1, "4K resolution is ultra-clear — so caught in 4K means caught with crystal-clear evidence."),
            translate("Translate this sentence", "He was caught red-handed lying", List.of("He", "was", "caught", "in", "4K", "lying"), "He was caught in 4K lying", "Caught red-handed with clear evidence = caught in 4K."),
            translate("Translate this sentence", "The video proves she was there", List.of("She", "was", "caught", "in", "4K", "no", "cap"), "She was caught in 4K no cap", "Undeniable video proof = caught in 4K.")
        ));

        lessonService.addLesson(lesson("Vibe Check", "purple", "Assessing someone's energy or mood.", "🎵"), List.of(
            intro("New Word: Vibe Check", "A \"vibe check\" is an assessment of someone's current energy, mood, or attitude. If you pass the vibe check, your energy is good. If you fail it, something is off.", "Example: \"Vibe check — you seem stressed today.\""),
            select("A vibe check is...", null, List.of("A music test", "An assessment of someone's mood or energy", "A vibration sensor", "A math quiz"), 1, "Vibe check = checking the vibe/energy someone is giving off."),
            select("If you fail the vibe check, you...", null, List.of("Have great energy", "Have won a prize", "Have bad or off energy", "Are very skilled"), 2, "Failing the vibe check means your vibe/energy is not good."),
            select("\"The whole party failed the vibe check\" means...", null, List.of("The party was amazing", "Nobody danced", "The energy of the whole party was off", "Everyone passed the test"), 2, "The energy of the whole party was wrong or uncomfortable."),
            translate("Translate this sentence", "Check if this place has good energy", List.of("Vibe", "check", "this", "place", "bussin", "ohio"), "Vibe check this place", "Assessing energy = vibe check."),
            translate("Translate this sentence", "His mood is completely off today", List.of("He", "failed", "the", "vibe", "check", "today"), "He failed the vibe check today", "Off energy = failed the vibe check.")
        ));

        lessonService.addLesson(lesson("Gyatt", "red", "Exclamation of admiration.", "😳"), List.of(
            intro("New Word: Gyatt", "\"Gyatt\" (also spelled \"gyat\") is an exclamation used to express admiration, usually at an attractive person. It is derived from a popular streamer's reaction.", "Example: \"Gyatt! Did you see her walk in?\""),
            select("\"Gyatt\" is best described as...", null, List.of("An insult", "A dance move", "An exclamation of admiration", "A type of food"), 2, "Gyatt is an exclamation expressing surprised admiration."),
            select("When would you say \"gyatt\"?", null, List.of("When something is disgusting", "When you see someone very attractive", "When you are bored", "When food is bussin"), 1, "Gyatt is said in reaction to someone you find very attractive."),
            select("\"Gyatt\" is closest in meaning to...", null, List.of("Yuck", "Wow", "Okay", "Maybe"), 1, "Gyatt is a surprised, admiring exclamation similar to 'wow'."),
            translate("Translate this sentence", "Wow she looks amazing", List.of("Gyatt", "she", "looks", "amazing", "bussin", "rizz"), "Gyatt she looks amazing", "Surprised admiration = Gyatt."),
            translate("Translate this sentence", "He walked in and everyone was shocked", List.of("He", "walked", "in", "gyatt", "no", "cap"), "He walked in gyatt no cap", "The slang phrase captures the admiring reaction.")
        ));
    }
